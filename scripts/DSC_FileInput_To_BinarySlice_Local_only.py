...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.initpathprefix = initpathprefix = "/home/bear/AlarmGnuRadioFiles/"
        self.pathprefix = pathprefix = "/home/bear/AlarmGnuRadioFiles/Captured/"
    ...
    def set_finput(self, finput):
        self.finput = finput
        self.set_foutput("/home/bear/AlarmGnuRadioFiles/Captured/"+finput.rsplit("/", 1)[1])
    ...
    def set_foutput(self, foutput):
        ...
        self.set_recfile4(self.foutput+"_AddConst"+str(self.addconst)+ "_DSC.dat")
    ...
    def set_recfile4(self, recfile4):
        ...
        self.blocks_file_sink_1.open(self.recfile4)
...
#    print "const:", const
    foutput = "/home/bear/AlarmGnuRadioFiles/Captured/"+finput.rsplit("/", 1)[1]

...
bitconvert_logger = logging.getLogger('log_alarm_signals.grc_bit_converter')
...
def set_values(name):
    ...
    bypass     = 0
    max_packet = 1000000000        # Known value from test packets
# max_packet = 250
